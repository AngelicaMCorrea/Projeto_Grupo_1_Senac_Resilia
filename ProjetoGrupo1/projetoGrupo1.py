...
def parse(value):  #define funções que se enquadram em duas grandes 
                   #categorias: análise de URL e colocação de aspas na URL
   """
 ...
 Returns:
   ...
   except:  #só vai entrar no except quando for exceção
